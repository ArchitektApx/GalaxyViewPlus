...
describe('SaveConfigWrapper', () => {
  ...
  beforeEach(() => {
    wrapper = new SaveConfigWrapper('someEvent', jest.fn())
  })
  ...
  describe('callback', () => {
    it("should call the inputCallback with 'saveConfig' and extracted input data", () => {
      ...
      wrapper = new SaveConfigWrapper('someEvent', mockCallback)
      wrapper.getWrapper().callback(mockEvent)

      expect(mockCallback).toHaveBeenCalledWith('saveConfig', expectedData)
    })
  })
})
